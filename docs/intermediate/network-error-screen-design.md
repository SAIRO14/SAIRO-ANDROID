...
네트워크 오류 화면은 실제 서버 요청이 전송되지 못했거나 제한 시간 안에 응답을 받지 못했을 때, 실패한 화면을 대신해 재시도와 홈 이동을 제공하는 전체 화면 상태다. 이 설계는 Figma의 [`Android_error_network`](https://www.figma.com/design/HT4c9y7Zf2BiGbDp6VQ7XX/%EC%82%AC%EC%9D%B4%EB%A1%9C-%EC%9C%A0%EC%A0%80-%EC%8B%9C%EB%82%98%EB%A6%AC%EC%98%A4-%EC%99%80%EC%9D%B4%EC%96%B4%ED%94%84%EB%A0%88%EC%9E%84-v2?node-id=1145-3397&m=dev)를 기준으로 한다.
